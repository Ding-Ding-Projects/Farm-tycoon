...
export const GOODS = {
  ...
  cookie:       { name: 'Cookie',          sellPrice: 100 },
  muffin:       { name: 'Strawberry Muffin', sellPrice: 220 },
  // dairy
  ...
  // grill
  pancakes:     { name: 'Pancakes',     sellPrice: 170 },
  bacon_eggs:   { name: 'Bacon & Eggs', sellPrice: 56 },
  baked_potato: { name: 'Baked Potato', sellPrice: 220 },
  burger:       { name: 'Burger',       sellPrice: 150 },
  // pie oven
  carrot_pie:     { name: 'Carrot Pie',     sellPrice: 80 },
  pumpkin_pie:    { name: 'Pumpkin Pie',    sellPrice: 116 },
  strawberry_pie: { name: 'Strawberry Pie', sellPrice: 310 },
  fish_pie:       { name: 'Fish Pie',       sellPrice: 170 },
  // loom & sewing
  cotton_fabric: { name: 'Cotton Fabric', sellPrice: 130 },
  sweater:       { name: 'Wool Sweater',  sellPrice: 104 },
  cotton_shirt:  { name: 'Cotton Shirt',  sellPrice: 470 },
  wooly_hat:     { name: 'Wooly Hat',     sellPrice: 300 },
  blue_hat:      { name: 'Blue Wooly Hat', sellPrice: 420 },
  // juice press
  ...
  grape_juice:   { name: 'Grape Juice',        sellPrice: 500 },
  // jam maker
  strawberry_jam: { name: 'Strawberry Jam', sellPrice: 300 },
  grape_jam:      { name: 'Grape Jam',      sellPrice: 810 },
  honey_jam:      { name: 'Honey Jam',      sellPrice: 200 },
  // coffee kiosk
  espresso:     { name: 'Espresso',     sellPrice: 400 },
  latte:        { name: 'Latte',        sellPrice: 430 },
  honey_coffee: { name: 'Honey Coffee', sellPrice: 510 },
  // candy machine
  ...
  mango_sorbet:     { name: 'Mango Sorbet',       sellPrice: 3260 },
  aloe_tonic:       { name: 'Aloe Tonic',         sellPrice: 3340 },
  ...
  // oil_press
  olive_oil:        { name: 'Olive Oil',            sellPrice: 1080 },
  herb_oil:         { name: 'Herb Oil',             sellPrice: 2490 },
  lavender_oil:     { name: 'Lavender Oil',         sellPrice: 1610 },
  // tea_house
  green_tea:        { name: 'Green Tea',            sellPrice: 1460 },
  milk_tea:         { name: 'Milk Tea',             sellPrice: 620 },
  honey_tea:        { name: 'Honey Tea',            sellPrice: 780 },
  mint_tea:         { name: 'Mint Tea',             sellPrice: 2740 },
  // sushi_bar
  sushi_roll:       { name: 'Sushi Roll',           sellPrice: 1600 },
  egg_sushi:        { name: 'Egg Sushi',            sellPrice: 1600 },
  rice_ball:        { name: 'Rice Ball',            sellPrice: 2020 },
  // perfumery
  air_freshener:    { name: 'Air Freshener',        sellPrice: 900 },
  perfume:          { name: 'Perfume',              sellPrice: 2810 },
  lotion:           { name: 'Lotion',               sellPrice: 3260 },
  // salad_bar
  ...
  pesto_pasta:      { name: 'Pesto Pasta',          sellPrice: 4540 },
  // fondue_pot
  ...
  mint_yogurt:      { name: 'Mint Yogurt',          sellPrice: 4310 },
  // sinks for the new animal products, added to existing buildings
  lamb_skewer:      { name: 'Lamb Skewer',          sellPrice: 820 },
  alpaca_scarf:     { name: 'Alpaca Scarf',         sellPrice: 420 },
  // kits for the ten buildings above
  kit_oil_press:            { name: 'Oil Press Kit',          sellPrice: 500 },
  kit_tea_house:            { name: 'Tea House Kit',          sellPrice: 730 },
  kit_sushi_bar:            { name: 'Sushi Bar Kit',          sellPrice: 720 },
  kit_perfumery:            { name: 'Perfumery Kit',          sellPrice: 830 },
  kit_salad_bar:            { name: 'Salad Bar Kit',          sellPrice: 740 },
  kit_pasta_kitchen:        { name: 'Pasta Kitchen Kit',      sellPrice: 780 },
  kit_fondue_pot:           { name: 'Fondue Pot Kit',         sellPrice: 750 },
  kit_preservation_station: { name: 'Preservation Kit',       sellPrice: 1250 },
  kit_jeweler:              { name: 'Jeweler Kit',            sellPrice: 1470 },
  kit_yogurt_maker:         { name: 'Yogurt Maker Kit',       sellPrice: 1520 },
  ...
  kit_sugar_mill:       { name: 'Sugar Mill Kit',       sellPrice: 290 },
  kit_popcorn_pot:      { name: 'Popcorn Pot Kit',      sellPrice: 320 },
  kit_grill:            { name: 'BBQ Grill Kit',        sellPrice: 640 },
  kit_pie_oven:         { name: 'Pie Oven Kit',         sellPrice: 300 },
  kit_loom:             { name: 'Loom Kit',             sellPrice: 470 },
  kit_sewing_machine:   { name: 'Sewing Machine Kit',   sellPrice: 490 },
  kit_juice_press:      { name: 'Juice Press Kit',      sellPrice: 530 },
  kit_jam_maker:        { name: 'Jam Maker Kit',        sellPrice: 650 },
  kit_coffee_kiosk:     { name: 'Coffee Kiosk Kit',     sellPrice: 640 },
  kit_candy_machine:    { name: 'Candy Machine Kit',    sellPrice: 770 },
  kit_tropical_cafe:    { name: 'Tropical Cafe Kit',    sellPrice: 920 },
  kit_smelter:          { name: 'Smelter Kit',          sellPrice: 750 },
};
