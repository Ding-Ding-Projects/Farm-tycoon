...
export const TUTORIAL = {
  ...
  steps: [
    ...
    { id: 'plant_wheat',  target: 'world:field',                   text: 'Tap an empty field, then drag the wheat seed across your fields to sow them — or tap it to plant one.', event: 'planted' },
